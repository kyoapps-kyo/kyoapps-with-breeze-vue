...
export const TileWrapper: React.FC<WrapperProps> = ({
    ...
    return (
        <TileContext.Provider value={{ numOfPages, currentPage }}>
            <div ref={refContainer} className="relative bg-black text-white" style={{height: numberOfPages * 100 + 'vh'}}>
                {children}
            </div>
...
export const Tile: React.FC<Props> = ({page, renderContent}}) => {
    ...
    return (<div ref={refContainer} className="absolute top-0 w-full" style={{
